...
import { FiRefreshCw, FiHelpCircle, FiDownload, FiBell, FiMenu, FiChevronDown } from "react-icons/fi";
      ...
      <div className='flex items-center justify-between w-full'>
        ...
        <nav aria-label="Header actions">
          <ul className='flex items-center gap-2'>
            ...
            <li>
              <button className='flex items-center gap-1 bg-white rounded shadow px-3 py-1'>
                <span className='w-3 h-3 rounded-full bg-yellow-400 inline-block' aria-label="Status: 5 of 6 phones online"></span>
                <span className='text-sm font-medium text-gray-700'>5 / 6 phones</span>
            ...
            <li>
              <button className='flex items-center justify-center bg-white rounded shadow px-3 py-1'>
                <FiMenu className='w-4 h-4 text-yellow-400' aria-label="Menu" />
              </button>
            </li>
          </ul>
        </nav>
